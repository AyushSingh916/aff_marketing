      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 w-full max-w-4xl">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex gap-6">
            <a href="https://www.facebook.com/profile.php?id=61561221100641" target="_blank" rel="noopener noreferrer">
              <FaFacebookF className="h-8 w-8 text-gray-700 hover:text-accent transition-colors" />
            </a>
            <a href="https://x.com/PeakPicks1" target="_blank" rel="noopener noreferrer">
