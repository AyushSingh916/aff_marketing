    ...
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl mt-1">
      <div className="md:flex">
        <div className="md:flex-shrink-0">
          <img className="h-48 w-full object-cover md:h-full md:w-48" src="/Bed.png" alt="Bed Frame" />
        </div>
        <div className="p-8">
          ...
          <div className="mt-4 flex justify-between">
            <a href="https://amazon.com" className="text-blue-500 hover:underline">$38 from Amazon</a>
            <a href="https://flipkart.com" className="text-blue-500 hover:underline">$39 from Flipkart</a>
          </div>
